                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-md avatar-indicators avatar-info">
                                                <img alt="avatar" src="/images/avatar/avatar-6.jpg" class="rounded-circle">
                                            </div>
                                        </div>
                                        <div class="col ms-n3">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-md avatar-indicators avatar-busy">
                                                <img alt="avatar" src="/images/avatar/avatar-7.jpg" class="rounded-circle">
                                            </div>
                                        </div>
                                        <div class="col ms-n3">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0 pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="#">
                                                <img src="/images/course/course-laravel.jpg" alt=""
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row">
                                        <div class="col-auto">
                                            <a href="#"><img src="/images/course/course-gatsby.jpg" alt=""
                                                    class="img-fluid rounded img-4by3-lg" /></a>
                                        </div>
                                        <div class="col ps-0">
                                            <a href="#">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row">
                                        <div class="col-auto">
                                            <a href="#">
                                                <img src="/images/course/course-javascript.jpg" alt=""
                                                    class="img-fluid rounded img-4by3-lg" /></a>
                                        </div>
                                        <div class="col ps-0">
                                            <a href="#">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row">
                                        <div class="col-auto">
                                            <a href="#">
                                                <img src="/images/course/course-wordpress.jpg" alt=""
                                                    class="img-fluid rounded img-4by3-lg" /></a>
                                        </div>
                                        <div class="col ps-0">
                                            <a href="#">
                            ...
                            <ul class="list-group list-group-flush list-timeline-activity">
                                ...
                                <li class="list-group-item px-0 pt-0  border-0 mb-2">
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-md avatar-indicators avatar-busy">
                                                <img alt="avatar" src="/images/avatar/avatar-4.jpg" class="rounded-circle">
                                            </div>
                                        </div>
                                        <div class="col ms-n2">
